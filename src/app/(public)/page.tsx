...
import { Factory, Zap, Droplets, HardHat, CheckCircle2, QrCode, TrendingUp } from 'lucide-react';

export default function Home() {
  return (
    <main>
      {/* Hero Section (Intacto para el futuro video) */}
      <section className="bg-brand-light py-20 border-b border-brand-grey/20">
        <div className="container mx-auto px-4 text-center max-w-4xl">
          ...
          <p className="text-xl text-brand-grey mb-10 leading-relaxed font-sans">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="bg-brand-white p-8 rounded-xl border border-brand-grey/10 hover:shadow-xl transition group">
              ...
              <h3 className="font-bold text-xl mb-3 text-brand-dark">Mantenimiento Predictivo</h3>
              <p className="text-brand-grey mb-6">Análisis de vibraciones, termografía y alineamiento láser para prevenir fallas catastróficas.</p>
            ...
            <div className="bg-brand-white p-8 rounded-xl border border-brand-grey/10 hover:shadow-xl transition group">
              ...
              <h3 className="font-bold text-xl mb-3 text-brand-dark">Capacitación Industrial</h3>
              <p className="text-brand-grey mb-6">Programas de formación en confiabilidad, alineamiento y termografía con diplomas oficiales.</p>
              <Link href="/capacitaciones" className="text-brand-teal font-bold hover:underline">Ver cursos &rarr;</Link>
            </div>
            ...
            <div className="bg-brand-white p-8 rounded-xl border border-brand-grey/10 hover:shadow-xl transition group">
              ...
              <h3 className="font-bold text-xl mb-3 text-brand-dark">Certificación y Control</h3>
              <p className="text-brand-grey mb-6">Calificación de soldadores y procedimientos bajo normas AWS, ASME y API.</p>
              <Link href="/servicios/calificacion-de-soldadores" className="text-brand-teal font-bold hover:underline">Ver normativas &rarr;</Link>
            </div>
          </div>
        </div>
      </section>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-brand-light/70 text-sm">Validación pública QR para todos nuestros diplomas y calificaciones de soldadores.</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="w-10 h-10 bg-brand-teal/20 rounded flex items-center justify-center shrink-0 mr-4">
            ...
            <div className="bg-white text-brand-dark p-8 md:p-12 rounded-2xl shadow-2xl relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-brand-grey mb-8">
                  Como Mandante o Jefe de Planta, usted puede verificar instantáneamente la autenticidad de las calificaciones de sus soldadores o las certificaciones de capacitación de su personal.
                </p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto text-center border-t border-brand-light pt-12">
            ...
            <div>
              ...
              <p className="text-brand-grey">contacto@fydingenieros.cl</p>
            </div>
            <div>
              <div className="w-12 h-12 bg-brand-light text-brand-teal rounded-full flex items-center justify-center mx-auto mb-4">
